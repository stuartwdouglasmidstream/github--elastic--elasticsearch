...
if [ -n "" ]; then
  echo "Creating tag 7.16.3 to match enforced version"
  git tag -m 7.16.3 -a 7.16.3 || true
else
  echo "Enforce version not set, recreating original tag v7.16.3"
  git tag -m v7.16.3 -a v7.16.3 || true
fi
